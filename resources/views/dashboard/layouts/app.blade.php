            ...
            <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
                <div class="app-brand demo">
                    <a href="{{route('dashboard.index')}}" class="app-brand-link">
                        ...
                        <span class="app-brand-text demo menu-text fw-bold ms-2">Vision</span>
                    </a>
                ...
                <ul class="menu-inner py-1">
                    ...
                    <!-- Layouts -->
                    <li class="menu-item {{request()->routeIs('dashboard.layouts') ? 'active open' : ''}}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                    ...
                    <li class="menu-item">
                        <a href="" class="menu-link">
                            ...
                            <div data-i18n="Email">Home Sections</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="" class="menu-link">
                            <i class="menu-icon tf-icons bx bxs-book-content"></i>
                            <div data-i18n="Chat">About Sections</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="{{route('dashboard.show')}}" class="menu-link">
                            <i class="menu-icon tf-icons bx bx-book-heart"></i>
                            <div data-i18n="Calendar">Courses Page</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="" class="menu-link">
                            <i class="menu-icon tf-icons bx bxs-contact"></i>
                            <div data-i18n="Calendar">Contact us Page</div>
                        </a>
                    </li>
                    <li class="menu-item">
                        <a href="" class="menu-link">
                        <i class="menu-icon tf-icons bx bx-book-content"></i>
                            <div data-i18n="Calendar">Other Pages</div>
                        </a>
                    </li>
                    <!-- Pages -->
                    <li class="menu-item">
                    ...
                    <!-- Courses -->
                    <li class="menu-item {{request()->routeIs('dashboard.create') ? 'active open' : ''}}">
                        <a href="javascript:void(0);" class="menu-link menu-toggle">
                            <i class="menu-icon tf-icons bx bx-layout"></i>
                        ...
                        <ul class="menu-sub">
                            <li class="menu-item {{request()->routeIs('dashboard.create') ? 'active' : ''}}">
                                <a href="{{route('dashboard.create')}}" class="menu-link">
                                    <div data-i18n="Without menu">Add courses</div>
                                </a>
                            </li>
                            <li class="menu-item">
                                <a href="{{asset('layouts-without-navbar.html')}}" class="menu-link">
                    ...
                    <li class="menu-item">
                        <a href="javascript:void(0)" class="menu-link menu-toggle">
                            ...
                            <div data-i18n="User interface">Members</div>
                        </a>
                        <ul class="menu-sub">
                            <li class="menu-item">
